...
* Крім того, ви можете постійно тримати словник профілю синхронізованим зі словником стандартного профілю, встановивши прапорець "Синхронізувати записи зі словником стандартного профілю".

    На відміну від кнопки імпорту, яка є явним одноразовим копіюванням, це живий накладний шар, який працює так:

    - Записи стандартного профілю набувають чинності для цього профілю, ніколи не записуючись у словник профілю, тож вони не з'являться у списку записів.
    - Записи об'єднуються під час обробки мовлення: ваші записи, специфічні для профілю, мають пріоритет, а будь-який запис стандартного профілю, чий шаблон ви не перевизначили, застосовується поверх них.
    - Оскільки це живе посилання, додавання або зміна запису у словнику стандартного профілю автоматично підхоплюється кожним синхронізованим профілем, без дублювання і без потреби повторного імпорту.
...
* Victor Tsai - підтримка клавіатурних жестів для словників
